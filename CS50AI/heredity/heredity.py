...
def joint_probability(people: dict, one_gene: set, two_genes: set, have_trait: set):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            mother_prob, father_prob = inherit_prob(mother, father, one_gene, two_genes)
...
def inherit_prob(mother, father, one_gene, two_genes):
    for parent in (mother, father):
        if parent in two_genes:
            yield 1 - PROBS['mutation']
        elif parent in one_gene:
            yield 0.5
        else:
            yield PROBS['mutation']
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    for person in probabilities.keys():
        probabilities[person]['gene'][2 if person in two_genes else 1 if person in one_gene else 0] += p
